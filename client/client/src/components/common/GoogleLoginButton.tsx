...
const GoogleLoginButton = ({ label = 'Continue with Google', theme = 'dark' }: Props) => {
  ...
  const baseClasses = "w-full flex items-center justify-center gap-3 py-2.5 rounded-xl border text-[0.8125rem] font-medium transition-all disabled:opacity-60 disabled:cursor-not-allowed mb-5";
